...
export default function Chat() {
  ...
  const handleStreamingSubmit = async (content) => {
    setGenerating(true)
    const _cancel_callback = apiContext.Inference.chatCompletionRequest({
      prompt: content,
  ...
  useEffect(() => {
    ...
    apiContext.Inference.subscribeChatCompletion(completionCallback)
    return () => {
      apiContext.Inference.unsubscribeChatCompletion(completionCallback)
    }
  }, [])
